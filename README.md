...
- _TODO: Home Public IP through TCP on Port 5601
...
- Docker.io, Python3-pip is installed using the apt module in linux.
- Increase virtual memory using sysctl.
- Download Docker container Image and configure with ports 9200:9200, 5601:5601 and 5044:5044 for Elasticsearch, Logstash and Kibana respectively. (ELK) 
- Enable service docker on boot so that it starts automatically.
